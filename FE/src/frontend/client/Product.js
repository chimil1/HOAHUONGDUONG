...
function Product() {
  ...
  const currentItems = productState.units.slice(indexOfFirstItem, indexOfLastItem);
            ...
            <div className="flex-w flex-sb-m p-b-52">
              <div className="flex-w flex-l-m filter-tope-group m-tb-10 btn-group">
                ...
                <div className="btn-group">
                  <button type="button" className="dropdown-toggle stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 "
                          data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                          data-reference="parent" id="dropdownMenuReference">Áo</button>
                            ...
                            <div className="block2">
                              ...
                              <div className="block2-txt flex-w flex-t p-t-14">
                                <div className="block2-txt-child1 flex-col-l">
                                  ...
                                  <span className="stext-105 cl3">{product.price}</span></div>
                                  </div>
                                </div>
                              </div>
                          ))}
