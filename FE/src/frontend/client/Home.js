...
function Home() {
  ...
  useEffect(() => {
    ...
    if (!productState.units || !productState.units.id) {
      dispatch(fetchProducts()); // Gọi lại sản phẩm nếu chưa có
    }
    ...
    <div className="App">
      ...
      <div className="container my-5">
        <div className="p-b-10">
          <h3 className="text-center text-uppercase text-dark fw-bold my-4">
            Sản phẩm nổi bật
          </h3>
        </div>
      ...
      <section className="bg0 p-t-23 p-b-140">
        <div className="container">
          <div className="p-b-10">
            <h3 className="text-center text-dark fw-semibold display-6 my-4">
              TỔNG QUAN SẢN PHẨM
            </h3>
          </div>
