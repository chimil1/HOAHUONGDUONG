                    ...
                    {sortOrder ?
                      (sortOrder === "asc" ? "Giá tăng dần" :
                        sortOrder === "desc" ? "Giá giảm dần" :
                          sortOrder === "a-z" ? "Tên A-Z" : "Tên Z-A") : "Chọn sắp xếp"
                    }
                  </button>
                  <ul className="dropdown-menu w-100" aria-labelledby="dropdownMenuSort">
                    <li><button className="dropdown-item" value="asc" onClick={handleSortChange}>Giá tăng dần</button></li>
                    <li><button className="dropdown-item" value="desc" onClick={handleSortChange}>Giá giảm dần</button></li>
                    <li><button className="dropdown-item" value="a-z" onClick={handleSortChange}>Tên A-Z</button></li>
                    <li><button className="dropdown-item" value="z-a" onClick={handleSortChange}>Tên Z-A</button></li>
                  </ul>
                </div>
              </div>
                      ...
                      <div className="block2">
                        ...
                        <div className="block2-txt flex-w flex-t p-t-14">
                          <div className="block2-txt-child1 flex-col-l">
                            <Link
                              to={`${product.id}`}
                              className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6 text-truncate"
