...
function OrderClient() {
  ...
  const isValidOrder = (order) => order && typeof order.status !== "undefined";
  ...
  // Sắp xếp đơn hàng theo ngày đặt hàng, gần nhất nằm trên
  const sortedOrders = filteredOrders.sort((a, b) => {
    const dateA = new Date(a.created_at); // Thay `created_at` bằng trường ngày đặt hàng nếu khác
